...
public class ChaxunpingzhengshActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_chaxunpingzhengsh);
		...
		(ChaxunpingzhengshActivity.this).getWindowManager().getDefaultDisplay().getMetrics(displayMetrics);
		this.dictCxpzTable = (TableLayout) findViewById(R.id.dictCxpzTable);
		
		this.loadPDialog = new ProgressDialog(this);
		this.loadPDialog.setMessage("正在处理，请稍候...");
	...
	{
		Toast.makeText(getApplicationContext(), "size " + pzidrowlist.size(), Toast.LENGTH_SHORT).show();
		int i = 0;
		for(ChaxunItem chaxunitem : pzidrowlist)
		{
			...
			TableRow row = new TableRow(ChaxunpingzhengshActivity.this);

			TextView tvdate = new TextView(ChaxunpingzhengshActivity.this);
			TextView tvpzid = new TextView(ChaxunpingzhengshActivity.this);
			TextView tvdes = new TextView(ChaxunpingzhengshActivity.this);
			TextView tvsubject = new TextView(ChaxunpingzhengshActivity.this);
			TextView tvlend = new TextView(ChaxunpingzhengshActivity.this);
			TextView tvload = new TextView(ChaxunpingzhengshActivity.this);
			TextView tvzhidan = new TextView(ChaxunpingzhengshActivity.this);
	...
	public void gocheckpz(View v)
	{
		Toast.makeText(getApplicationContext(), "已审核", Toast.LENGTH_SHORT).show();
	}

	protected void docheckpz() {
		// TODO Auto-generated method stub
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.chaxunpingzhengsh, menu);
		return true;
	}
